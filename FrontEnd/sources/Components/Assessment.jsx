...
let message = '';
  ...
  return (
    <div className="assessment-container">
      ...
      <h1 className="assessment-title" style={{backgroundColor:'darkblue',marginLeft:'440px',width:'26%',color:"white",borderRadius:"25px",marginBottom:'10px',display:'flex',alignItems:'center',justifyContent:'center'}}>Questions</h1></div>
      <div className="assessment-form">
        ...
        <div style={{padding: '20px 0 0 0 '}}>
          ...
          <button onClick={()=>navigate(0)} className="submit-button" style={{marginLeft:"30px",padding:"5px 15px"}}>Refaire</button>
          <button onClick= {()=>{handleMarks();setOpenModal(true)}}
          className="submit-button11" >Valider</button>
        </div>
      </div>
      <Modal
        id="poppup"
      ...
      >
        ...
        <h2 style={{color:'darkblue'}}>Résultat</h2>
        <h1 style={{textAlign:"center"}}>{message}</h1>
        <h3 style={{display:'flex',justifyContent:'center'}}>Vous avez eu un score de {(correctCount/totalQsns)*100} %</h3>
